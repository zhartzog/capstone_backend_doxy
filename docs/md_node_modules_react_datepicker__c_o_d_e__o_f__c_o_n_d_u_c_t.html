...
<title>Backend: Contributor Covenant Code of Conduct</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_react_datepicker__c_o_d_e__o_f__c_o_n_d_u_c_t.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div class="contents">
<div class="textblock"><h1><a class="anchor" id="autotoc_md557"></a>
Our Pledge</h1>
...
Enforcement</h1>
<p>Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by contacting the project team at <a href="#" onclick="location.href='mai'+'lto:'+'con'+'ta'+'ct@'+'re'+'act'+'da'+'tep'+'ic'+'ker'+'.c'+'om'; return false;">conta<span style="display: none;">.nosp@m.</span>ct@r<span style="display: none;">.nosp@m.</span>eactd<span style="display: none;">.nosp@m.</span>atep<span style="display: none;">.nosp@m.</span>icker<span style="display: none;">.nosp@m.</span>.com</a>. The project team will review and investigate all complaints, and will respond in a way that it deems appropriate to the circumstances. The project team is obligated to maintain confidentiality with regard to the reporter of an incident. Further details of specific enforcement policies may be posted separately.</p>
