...
<title>Backend: Time Zones</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_date_fns_docs_time_zones.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div class="title">Time Zones </div>  </div>
</div><!--header-->
<div class="contents">
...
<li><a href="#date-fns-tz"><code>date-fns-tz</code></a></li>
</ul>
...
&lt;a href="https://www.npmjs.com/package/date-fns-tz"&gt;&lt;tt&gt;date-fns-tz&lt;/tt&gt;&lt;/a&gt;</h1>
...
Synopsis</h2>
<div class="fragment"><div class="line">const { zonedTimeToUtc, utcToZonedTime, format } = require(&#39;date-fns-tz&#39;)</div>
<div class="line"> </div>
<div class="line">// Set the date to &quot;2018-09-01T16:01:36.386Z&quot;</div>
<div class="line">const utcDate = zonedTimeToUtc(&#39;2018-09-01 18:01:36.386&#39;, &#39;Europe/Berlin&#39;)</div>
<div class="line"> </div>
<div class="line">// Obtain a Date instance that will render the equivalent Berlin time for the UTC date</div>
<div class="line">const date = new Date(&#39;2018-09-01T16:01:36.386Z&#39;)</div>
<div class="line">const timeZone = &#39;Europe/Berlin&#39;</div>
<div class="line">const zonedDate = utcToZonedTime(date, timeZone)</div>
<div class="line">// zonedDate could be used to initialize a date picker or display the formatted local date/time</div>
<div class="line"> </div>
<div class="line">// Set the output to &quot;1.9.2018 18:01:36.386 GMT+02:00 (CEST)&quot;</div>
<div class="line">const pattern = &#39;d.M.yyyy HH:mm:ss.SSS \&#39;GMT\&#39; XXX (z)&#39;</div>
<div class="line">const output = format(zonedDate, pattern, { timeZone: &#39;Europe/Berlin&#39; })</div>
